...
public class BookServiceOfficerRequest {
    ...
    public BookServiceOfficerRequest() {}
    
    public BookServiceOfficerRequest(String customerId, String receiverName, String receiverAddress, String receiverPin,
