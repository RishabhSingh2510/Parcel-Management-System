...
public class BookServiceOfficerResponse {
    ...
    public BookServiceOfficerResponse() {}
    

    public BookServiceOfficerResponse(Long bookingId, String customerId, String customerName, String customerAddress,
