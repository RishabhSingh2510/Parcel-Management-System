...
public class PickupDropUpdateResponse {
    ...
    public PickupDropUpdateResponse() {}

    public PickupDropUpdateResponse(Long bookingId, String fullName, String address, String receiverName,
			String receiverAddress, LocalDateTime dateOfBooking, String status, LocalDateTime parcelPickupTime,
			LocalDateTime parcelDropoffTime, String message) {
		super();
